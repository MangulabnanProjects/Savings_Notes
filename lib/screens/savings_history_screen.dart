...
class SavingsHistoryScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    savingsEntries.sort((a, b) => 
      (b['timestamp'] as DateTime).compareTo(a['timestamp'] as DateTime));
    
    // Calculate total
    final totalSavings = savingsEntries.fold(0.0, (sum, e) => sum + (e['amount'] as double));
                  ...
                  ? Center(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            'Start adding savings from the calendar!',
                        ...
                        return Card(
                          ...
                          child: ListTile(
                            leading: Container(
                              ...
                              child: const Icon(Icons.savings, color: Color(0xFF4CAF50)),
                            ),
                            title: Text(
